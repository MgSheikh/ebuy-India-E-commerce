	...
	<div>
		<div class="homepageheader">
			...
			<div style="float: left; margin: 5px 0px 0px 23px;">
				<a href="index.php">
					<img style=" height: 75px; width: 130px;" src="image/ebuy_india.png">
				</a>
			</div>
			<div class="">
				<div id="srcheader">
						...
						<div>
							<form action="" method="POST" class="registration">
								<div class="signup_form">
									<div>
										<td>
											<input type="text" name="username" class="email signupbox" placeholder="Write eBuy-India Email..." size="30" required autofocus>
										</td>
									</div>
									<div>
